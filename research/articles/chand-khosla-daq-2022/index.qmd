...
doha:
  devanagari:
    - "यंत्र समय चाल सुधरे, हर पल सही समय पाय।"
    - "मुफ्त यंत्र सबको मिले, शोध सरल हो जाय॥"
  english:
    - "The tool corrects time's stumble; each moment finds its true pace"
    - "Free, open, for all who seek it; the work turns simple and clear"
---
